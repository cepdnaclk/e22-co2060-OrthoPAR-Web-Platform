...
# Set up paths so we can import from the parent backend package
...
def test_calc_overbite():
    ...
    lower = {
        ...
        "R1Lower": Point3D(0, 0, 0)  # Gum of lower at Z=0 (Updated naming)
    }
    # Lower height is 5.
...
def test_full_calculate_par_score():
    ...
    lower = [
        LandmarkCreate(point_name="R1Mid", x=0, y=0, z=0, scan_id=sid), 
        LandmarkCreate(point_name="R1Lower", x=0, y=0, z=-5, scan_id=sid) # Updated naming
    ]
