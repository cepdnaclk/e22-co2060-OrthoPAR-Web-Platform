        ...
        <div style={{ padding: "24px 28px" }}>
          {loading ? (
            ...
            <div className="table-card">
              {/* Column Headers */}
              <div className="table-header" style={{ gridTemplateColumns: "36px 1.5fr 2fr 1fr 1fr 80px" }}>
                <div></div>
              ...
              {filtered.map(p => {
                ...
                return (
                  <div key={p.id}>
                    ...
                    <div
                      className="table-row"
                      style={{ gridTemplateColumns: "36px 1.5fr 2fr 1fr 1fr 80px", cursor: "pointer", background: isExpanded ? "#F0F7FF" : "white" }}
